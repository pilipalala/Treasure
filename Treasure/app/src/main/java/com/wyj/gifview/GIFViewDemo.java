 ...
 * @describe 添加描述
 */
public class GIFViewDemo extends View {
    ...
    public GIFViewDemo(Context context) {
        this(context, null);
    }

    public GIFViewDemo(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GIFViewDemo(Context context, AttributeSet attrs, int defStyleAttr) {
