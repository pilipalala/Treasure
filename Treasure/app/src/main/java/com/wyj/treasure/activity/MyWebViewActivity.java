...
import com.wyj.treasure.utils.ImageUtil;
import com.wyj.treasure.utils.MyWebChomeClient;
import com.wyj.treasure.utils.PermissionUtil;
...
public class MyWebViewActivity extends BaseActivity implements MyWebChomeClient.OpenFileChooserCallBack {
    ...
    protected void initData() {
        ...
        mWebView.setWebChromeClient(new MyWebChomeClient(MyWebViewActivity.this));
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which == 0) {
                            if (PermissionUtil.isOverMarshmallow()) {
                                if (!PermissionUtil.isPermissionValid(MyWebViewActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                                    Toast.makeText(MyWebViewActivity.this,
                            ...
                            if (PermissionUtil.isOverMarshmallow()) {
                                if (!PermissionUtil.isPermissionValid(MyWebViewActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                                    Toast.makeText(MyWebViewActivity.this,
                                            "请去\"设置\"中开启本应用的图片媒体访问权限",
                                            Toast.LENGTH_SHORT).show();
                                ...
                                if (!PermissionUtil.isPermissionValid(MyWebViewActivity.this, Manifest.permission.CAMERA)) {
                                    Toast.makeText(MyWebViewActivity.this,
                                            "请去\"设置\"中开启本应用的相机权限",
                                            Toast.LENGTH_SHORT).show();
    ...
    private void requestPermissionsAndroidM() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            PermissionUtil.requestPermissions(MyWebViewActivity.this, P_CODE_PERMISSIONS, needPermissionList);
    ...
    public void requestResult(String[] permissions, int[] grantResults) {
        ...
        if (needPermissions.size() > 0) {
            ...
            Toast.makeText(MyWebViewActivity.this, strMessage, Toast.LENGTH_SHORT).show();
